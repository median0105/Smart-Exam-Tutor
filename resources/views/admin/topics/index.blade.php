<x-app-layout>
    ...
    <div class="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <form method="POST" action="{{ route('admin.topics.store') }}" class="panel p-6">@csrf
            ...
            <input name="name" class="input-shell admin-input-shell" placeholder="Nama topik">
            <input name="target_mastery_percentage" class="input-shell admin-input-shell" type="number" value="75">
            <textarea name="description" class="input-shell admin-input-shell" placeholder="Deskripsi topik"></textarea>
