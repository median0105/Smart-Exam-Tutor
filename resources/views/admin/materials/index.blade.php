<x-app-layout>
    ...
    <div class="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <form method="POST" action="{{ route('admin.materials.store') }}" class="panel p-6">@csrf
            ...
            <input name="title" class="input-shell" placeholder="Judul materi">
            <input name="tags" class="input-shell" placeholder="Tag, dipisah koma">
            <div class="grid gap-4 sm:grid-cols-2"><select name="difficulty" class="input-shell"><option value="easy">Mudah</option><option value="medium">Sedang</option><option value="hard">Sulit</option></select><input type="number" name="estimated_minutes" class="input-shell" value="15"></div>
            <textarea name="summary" class="input-shell" placeholder="Ringkasan"></textarea>
            <textarea name="content" class="input-shell min-h-48" placeholder="Isi materi"></textarea>
