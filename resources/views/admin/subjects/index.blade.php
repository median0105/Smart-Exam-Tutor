<x-app-layout>
    ...
    <div class="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <form method="POST" action="{{ route('admin.subjects.store') }}" class="panel p-6">@csrf
            ...
            <input name="name" class="input-shell admin-input-shell" placeholder="Nama mapel">
            <input name="code" class="input-shell admin-input-shell" placeholder="Kode mapel">
            <input name="color" class="input-shell admin-input-shell" placeholder="Contoh: from-blue-500 to-violet-500">
            <textarea name="description" class="input-shell admin-input-shell" placeholder="Deskripsi singkat"></textarea>
