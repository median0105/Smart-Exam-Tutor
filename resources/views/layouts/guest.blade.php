...
<body class="overflow-hidden font-['Outfit',sans-serif] antialiased">
    <div
        class="relative flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.4),_transparent_24%),radial-gradient(circle_at_85%_15%,_rgba(139,92,246,0.33),_transparent_24%),linear-gradient(180deg,_#020617,_#0f172a_45%,_#111827)] px-4 py-6">
